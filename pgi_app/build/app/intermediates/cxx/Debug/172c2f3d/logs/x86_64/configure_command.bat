...
"C:\\Users\\Lenovo\\AppData\\Local\\Android\\Sdk\\cmake\\3.22.1\\bin\\cmake.exe" ^
  ...
  "-DCMAKE_LIBRARY_OUTPUT_DIRECTORY=D:\\Patient Management\\pgi_app\\build\\app\\intermediates\\cxx\\Debug\\172c2f3d\\obj\\x86_64" ^
  "-DCMAKE_RUNTIME_OUTPUT_DIRECTORY=D:\\Patient Management\\pgi_app\\build\\app\\intermediates\\cxx\\Debug\\172c2f3d\\obj\\x86_64" ^
  "-DCMAKE_BUILD_TYPE=Debug" ^
  "-BD:\\Patient Management\\pgi_app\\build\\.cxx\\Debug\\172c2f3d\\x86_64" ^
  -GNinja ^
  -Wno-dev ^
  --no-warn-unused-cli
