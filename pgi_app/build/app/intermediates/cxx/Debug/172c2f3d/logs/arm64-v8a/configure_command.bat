...
"C:\\Users\\Lenovo\\AppData\\Local\\Android\\Sdk\\cmake\\3.22.1\\bin\\cmake.exe" ^
  ...
  "-DCMAKE_LIBRARY_OUTPUT_DIRECTORY=D:\\Patient Management\\pgi_app\\build\\app\\intermediates\\cxx\\Debug\\172c2f3d\\obj\\arm64-v8a" ^
  "-DCMAKE_RUNTIME_OUTPUT_DIRECTORY=D:\\Patient Management\\pgi_app\\build\\app\\intermediates\\cxx\\Debug\\172c2f3d\\obj\\arm64-v8a" ^
  "-DCMAKE_BUILD_TYPE=Debug" ^
  "-BD:\\Patient Management\\pgi_app\\build\\.cxx\\Debug\\172c2f3d\\arm64-v8a" ^
  -GNinja ^
  -Wno-dev ^
  --no-warn-unused-cli
