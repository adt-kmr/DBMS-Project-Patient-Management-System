...
"C:\\Users\\Lenovo\\AppData\\Local\\Android\\Sdk\\cmake\\3.22.1\\bin\\cmake.exe" ^
  ...
  "-DCMAKE_LIBRARY_OUTPUT_DIRECTORY=D:\\Patient Management\\pgi_app\\build\\app\\intermediates\\cxx\\Debug\\172c2f3d\\obj\\armeabi-v7a" ^
  "-DCMAKE_RUNTIME_OUTPUT_DIRECTORY=D:\\Patient Management\\pgi_app\\build\\app\\intermediates\\cxx\\Debug\\172c2f3d\\obj\\armeabi-v7a" ^
  "-DCMAKE_BUILD_TYPE=Debug" ^
  "-BD:\\Patient Management\\pgi_app\\build\\.cxx\\Debug\\172c2f3d\\armeabi-v7a" ^
  -GNinja ^
  -Wno-dev ^
  --no-warn-unused-cli
